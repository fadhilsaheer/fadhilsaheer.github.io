...
type ReactComponent<Props = {}> = React.FC<React.PropsWithChildren<Props>>;
...
export const Body: ReactComponent<Props> = ({ children, Navbar }) => {
  return (
    <div
      id='home'
      className='bg-gray-900 antialiased selection:bg-purple-500/90 selection:text-white'
    >
      <svg
